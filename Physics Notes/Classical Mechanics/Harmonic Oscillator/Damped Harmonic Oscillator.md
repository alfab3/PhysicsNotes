...
The balance of forces for damped harmonic oscillators is then 
$$
...
2) Critically damped $\xi = 1$: The syste, returns to steady state as quickly as possible without oscillating. This is oftern desired for the damping of syte,s such as doors
